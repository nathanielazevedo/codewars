  ...
  return (
    <div className="min-h-screen arena-bg">
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        ...
        {addMessage && (
          <div
            className={`mb-6 rounded-lg px-4 py-2.5 text-sm ${addMessage.type === 'success' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}
          >
            {addMessage.text}
          </div>
        )}
                  ...
                  {outgoing.map((user) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="rounded-lg bg-gray-700 p-2 hover:bg-gray-600 transition-colors text-xs"
                        title="Cancel"
                      >
                        Cancel
                      </button>
